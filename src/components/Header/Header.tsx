      ...
      <div className='container'>
        <div className='flex justify-end'>
          ...
          >
            ...
            <span className='mx-1 mb-1'>Tiếng Việt</span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
          ...
          {isAuthenticated && (
              ...
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm'>
                  <div className='flex flex-col w-36'>
                    <Link
                      to={pagePath.profile}
                      className='p-2.5 font-medium hover:text-teal-400 hover:bg-gray-50 text-left'
                    >
            ...
            >
              <div className='w-5 h-5 mr-2 flex-shrink-0 mb-1'>
                <img
          ...
          {!isAuthenticated && (
            <div className='flex items-center py-1 ml-6'>
              <Link className='capitalize hover:text-gray-300 mx-3 mb-1' to={pagePath.signup}>
                sign up
              </Link>
              <div className='border-r-[1px] border-r-white/40 h-4'></div>
              <Link className='capitalize hover:text-gray-300 mx-3 mb-1' to={pagePath.login}>
                login
              </Link>
            </div>
          )}
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          ...
          <Popover
            ...
            renderPopover={
              <div className='bg-white max-w-[400px] relative shadow-md rounded-sm text-sm'>
                <div className='p-2'>
                  ...
                  <div className='flex items-center mt-6 justify-between'>
                    <div className='capitalize text-sm text-gray-500'>add to cart</div>
                    <button className='capitalize bg-orange rounded-sm text-white px-4 py-2 hover:bg-opacity-90'>
