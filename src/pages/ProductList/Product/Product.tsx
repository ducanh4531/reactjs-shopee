    ...
    <Link to={pagePath.home}>
      <div className='bg-white shadow overflow-hidden rounded-sm hover:translate-y-[-0.04rem] hover:shadow-md duration-100 transition-transform'>
        <div className='relative w-full pt-[100%]'>
          <img
            src='https://down-vn.img.susercontent.com/file/c1adc9a5e622bf3f645a7e2ac446cd13_tn'
            alt='product'
        ...
        <div className='p-2 overflow-hidden'>
          <div className='min-h-[2rem] line-clamp-2 text-xs'>
            Chuột máy tính Gaming Latope chuột máy tính có dây Full Led chơi game K2
          </div>
